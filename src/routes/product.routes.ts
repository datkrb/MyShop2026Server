...
router.post('/:id/images', authMiddleware, requireRole(UserRole.ADMIN), cloudinaryUpload.array('images', 10), productController.uploadImages.bind(productController));
